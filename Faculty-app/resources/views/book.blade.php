      ...
      <form class="d-flex">
        ...
        <div class="row">
            ...
            <table class="table">
                <tr>
                    <td>BOOK TITLE</td>
                    <td><input name="bot"type="text" class="form-control"></td>
                </tr>
                <tr>
                    <td>AUTHOR</td>
                    <td><input name="boa"type="text" class="form-control"></td>
                </tr>
                <tr>
                    <td>DESCRIPTION</td>
                    <td><input name="bod"type="text" class="form-control"></td>
                </tr>
                <tr>
                    <td>DISTRIBUTOR</td>
                    <td><input name="bodi"type="text" class="form-control"></td>
                </tr>
                <tr>
                    <td>PRICE</td>
                    <td><input name="bop"type="text" class="form-control"></td>
                </tr>
                <tr>
